                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">إضافة محتويات الالبان
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{route('milk.store')}}" method="POST"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="catogre" class="select2 form-control">
                                                            <optgroup label="من فضلك أختر الصنف  ">
                                                                <option value="chess"> جبنة</option>
                                                                <option value="fatness"> سمنة</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="story" name="description" rows="5" cols="33">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div id="upload-button" class="button">اختر الفديو  المناسب </div>
                                                            <div id="upload-input">
                                                                <input id="video_file" name="video" type="file" >
                                                            </div>
                                                        <span class="text-danger"> </span>
                                                    </div>
                                                </div>
